...
//-----------------------------------------------------------------------------------------------------------Construtor:
    ...
    {                                                                                                              //
        ...
        //---------------//
        btnSalvar.addActionListener    (new SalvarDesenho());                                                      //Adicionamos um tratamento de eventos ao bot�o Salvar;                                                                                                               
        btnAbrir.addActionListener     (new AbrirDesenho());                                                       //Adicionamos um tratamento de eventos ao bot�o Abrir;                                                                                                               
        //--------------//
...
//-----------------------------------------------------------------------------------------------------------Auxiliares:  
    ...
    //---------------------------//                                                                                //
    protected class SalvarDesenho implements ActionListener                                                        //Classe que trata o evento do bot�o Ponto:
    {                                                                                                              //
          ...
          {   
        	  ...
        	  email = JOptionPane.showInputDialog(frame, "Qual o email a ser utilizado?");
        	  nome = JOptionPane.showInputDialog(frame, "Qual o nome do Desenho?");
        	  
        	  for(int i=0 ; i < figuras.size(); i++)
        	  {
        		  desenho.add(i, figuras.elementAt(i).toString());
        	  }
    ...
    protected class AbrirDesenho implements ActionListener                                                        //Classe que trata o evento do bot�o Ponto:
    {                                                                                                              //
          public void actionPerformed (ActionEvent e)                                                              //M�todo no formato requerido pela implementa��o:
          {               
              ...
              PedidoDeDesenhoSalvo pedido = new PedidoDeDesenhoSalvo(email,nome);
              try {
              ...
              for(int i=0 ; i < desenhos.size(); i++)
        	  {
            	  ...
            	  switch(figuraAtual.charAt(0))
            	  {
            	  case 'L':
            		  figuraFinal = new Linha(figuraAtual);
            		  
            		  break;
            	  case 'P':
            		  figuraFinal = new Ponto(figuraAtual);
            		  break;
            	  case 'C':
            		  figuraFinal = new Circulo(figuraAtual);
            		  break;
            	  case 'E':
            		  figuraFinal = new Elipse(figuraAtual);
            		  break;
            	  case 'Q':
            		  figuraFinal = new Quadrado(figuraAtual);
            		  break;
            	  case 'R':
